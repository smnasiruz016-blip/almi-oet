  ...
  },
  {
    ...
    "payload": {
      "passages": [
        {
          "id": "p1",
          "body": "The position of a newly placed tube is confirmed before anything at all is passed down it, including water.\nAspirate is obtained and tested on pH indicator paper made for human gastric aspirate, and a reading of 5.5 or\nbelow allows feeding to begin.\nWhere no aspirate can be obtained, turn the patient onto their side and try again after fifteen to twenty\nminutes. Advancing or withdrawing the tube by ten centimetres may also help.\nAir must not be pushed down the tube and listened for with a stethoscope. That test has been withdrawn because\nit cannot distinguish the stomach from the lung.\nIf the pH is above 5.5, or no aspirate is obtained after two attempts, an X-ray is requested and reported by\nsomebody trained to confirm the position.\nRecord which of these was done and at what time, so that the next person does not begin again from the start."
        }
      ],
      "questions": [
        {
  ...
  },
  {
    ...
    "payload": {
      "passages": [
        {
          "id": "p1",
          "body": "From Monday, fluid balance charts will be totalled at the end of every shift rather than once in twenty-four\nhours. Write the running total in the box provided and sign it, so that the next shift begins with a figure\ninstead of a column of entries to add up.\nPlease record what was actually taken and not what was offered. A jug left at the bedside is not intake, and a\ncup half returned is not a full cup.\nOutput includes the losses that are easiest to forget: vomit, drain fluid, stoma output and heavy wound\nexudate.\nWhere an amount cannot be measured, write what it was and state that it was not measured, rather than leaving\nthe line blank.\nTotals written in pencil, or written on a scrap of paper to be copied up later, do not count as totals at all."
        }
      ],
      "questions": [
        {
  ...
  },
  {
    ...
    "payload": {
      "passages": [
        {
          "id": "p1",
          "body": "Every meter on the ward must have its internal quality control run at the start of each day on which it is\nused, and the result logged. A meter that has not been controlled that day is not used on a patient, whatever\nthe hurry.\nControl solutions are dated when they are opened and discarded three months later, or at the manufacturer's\nexpiry date if that falls first. A solution kept beyond either date will give a result that looks entirely\nnormal and means nothing.\nIf a control result falls outside the printed range, the meter is taken out of service and labelled. Do not\nleave it on the trolley for somebody else to find. Report it the same day.\nLog the result even when it passes. A run with no record is the same as a run that never happened."
        }
      ],
      "questions": [
        {
  ...
  },
  {
    ...
    "payload": {
      "passages": [
        {
          "id": "p1",
          "body": "A patient with a known or suspected latex allergy is nursed with latex-free equipment from the moment of\nadmission, and the alert is added to the record before any procedure is booked.\nLatex-free does not mean powder-free. Powdered latex gloves are not used anywhere in this department, because\nthe powder carries latex protein into the air and a patient in an adjoining bay can react without ever having\nbeen touched.\nTheatre is informed at the point of listing and not on the morning of surgery, so that the case can be placed\nfirst on the list and the room can be left standing empty overnight.\nStaff who develop a rash after using gloves report it to occupational health, rather than quietly changing\nglove brand on their own.\nTell the patient what has been arranged for them, and check that they can repeat it back before they go for\nthe procedure."
        }
      ],
      "questions": [
        {
  ...
  },
  {
    ...
    "payload": {
      "passages": [
        {
          "id": "p1",
          "body": "A decision not to attempt resuscitation is recorded on the form, and the form travels with the patient. It is\nnot valid on its own once the patient moves into a different service: the receiving team reviews it and either\nadopts it or replaces it, and records which of the two it did.\nThe decision concerns cardiopulmonary resuscitation and nothing else. It does not limit antibiotics, fluids,\npain relief, admission to hospital or any other treatment, and staff who read it as a general ceiling of care\nhave misread it.\nThe conversation with the patient, or with those close to a patient who lacks capacity, is recorded with the\ndate and with who was present. A form that has no conversation behind it will not survive a review.\nKeep the original in the notes, and do not rely on a photocopy travelling separately in an envelope."
        }
      ],
      "questions": [
        {
  ...
  },
  {
    ...
    "payload": {
      "passages": [
        {
          "id": "p1",
          "body": "A chaperone is offered for every intimate examination, whatever the gender of the patient and of the\nclinician, and the offer is made before the patient undresses.\nThe chaperone is a trained member of staff. A relative or a friend may stay at the patient's request, but they\ndo not count as the chaperone, and their presence does not remove the need to make the offer.\nRecord the offer, the name and role of the chaperone, and, where the offer was declined, that it was declined.\nAn entry reading only 'chaperone present' names nobody and proves nothing.\nWhere no chaperone is available and the examination can wait, it waits.\nOffer again if the patient hesitates the first time. Somebody who says no because they feel they are causing\ntrouble has not really been offered anything at all, and the second offer costs nothing to make."
        }
      ],
      "questions": [
        {
  ...
  },
  {
    ...
    "payload": {
      "passages": [
        {
          "id": "p1",
          "body": "Bed rails are not a routine measure, and they are not fitted because a patient is old, confused, or alone in a\nside room. They are fitted after an individual assessment which records the particular risk they are intended\nto reduce.\nRails do not prevent falls. They prevent a patient rolling out of bed. A patient who is trying to get out of\nbed will climb over them, and a fall from that height is worse than the fall the rails were fitted to stop.\nReassess whenever the patient's condition changes, and at least weekly. Record the reassessment even where\nnothing has changed, because an unrecorded reassessment cannot be told apart from one that never happened.\nInvolve the patient in the decision wherever they are able to take part, and record what they said about it."
        }
      ],
      "questions": [
        {
  ...
  },
  {
    ...
    "payload": {
      "passages": [
        {
          "id": "p1",
          "body": "Every antimicrobial started in this hospital carries a review point at forty-eight hours, and the review is\nwritten on the chart even where the decision is to continue unchanged. Four outcomes are available: stop,\nswitch from the drip to tablets, change the drug, or continue with a stated end date.\nContinue with no end date is not one of them. A course with no end date is the commonest way in which a three-\nday treatment becomes a three-week one.\nThe indication is written on the chart when the drug is prescribed, and not added later from memory. A drug\nwith no indication cannot be reviewed by anybody except the person who started it, and that person may be off\nduty.\nName the person responsible for the review on the chart, so that it belongs to somebody rather than to the\nward in general."
        }
      ],
      "questions": [
        {
  ...
  },
  {
    ...
    "payload": {
      "passages": [
        {
          "id": "p1",
          "body": "Oxygen is a drug and it is prescribed. The prescription states a target saturation range and not a fixed\nnumber of litres, because the amount the patient needs changes through the day while the target does not.\nThe usual target is 94 to 98 per cent. For a patient at risk of carbon dioxide retention the target is 88 to\n92 per cent, and that range is written on the chart at the moment the risk is identified, rather than after\nthe first blood gas comes back.\nRecord the delivery device and the flow rate at every observation round. A saturation written down without the\noxygen beside it can be read a shift later as a patient who was breathing air.\nSign the prescription in the same way as any other, and date it. An unsigned entry cannot be acted on safely\nby anybody else."
        }
      ],
      "questions": [
        {
  ...
  },
  {
    ...
    "payload": {
      "passages": [
        {
          "id": "p1",
          "body": "Property brought in with a patient is listed on the property form at the point of admission, by two members of\nstaff, and the patient or their relative signs the list wherever they are able to.\nValuables are not kept in the bedside locker. They go to the safe and the receipt goes in the notes. A locker\nkey held at the nurses' station is not a safe.\nWhere a patient arrives unconscious and alone, the list is still made by two members of staff and\ncountersigned, and the fact that nobody could confirm it is written on the form.\nDo not record a yellow metal ring as a gold ring. You are recording what you can see.\nGive the patient or their relative a copy of the completed list before it goes anywhere else in the notes."
        }
      ],
      "questions": [
        {
  ...
  },
  {
    ...
    "payload": {
      "passages": [
        {
          "id": "p1",
          "body": "Waste is separated at the point at which it is produced, and it is never sorted again afterwards. A bag that\nhas been closed is not reopened.\nSharps go into the rigid container whether or not they are contaminated, and a sharp found inside a waste bag\nis treated as an injury waiting to happen rather than as a sorting mistake.\nCytotoxic and cytostatic waste has its own container and does not enter the ordinary clinical stream at any\npoint.\nBags are filled to three-quarters, closed with the tag, and labelled with the ward. An unlabelled bag cannot\nbe traced back, and every unlabelled bag is a ward that will never be told.\nWear the gloves and apron for the task, and take them off before touching anything else, including the door.\n\nA bag that has been left standing in a corridor while somebody goes to find the trolley has already\nstopped being anybody's responsibility."
        }
      ],
      "questions": [
        {
  ...
  },
  {
    ...
    "payload": {
      "passages": [
        {
          "id": "p1",
          "body": "A student may carry out a task only where it is within the level they have reached, and where a registered\nmember of staff has agreed to it beforehand. Agreement afterwards is not supervision.\nCountersigning means that the registered member of staff was present, or has satisfied themselves by some\nother means that the entry is accurate. It does not mean that the student is considered reliable in general.\nDo not countersign an administration you did not witness. A signature saying that a drug was checked when it\nwas not is a false record, whatever was intended by it.\nA student who is asked to work beyond their level should say so, and should be thanked for saying so.\nAsk the student what they have already been signed off to do, and check it against the record rather than\nagainst their answer alone."
        }
      ],
      "questions": [
        {
