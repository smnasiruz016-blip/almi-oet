...
export const ITEMS: Prisma.OetItemCreateManyInput[] = [
  ...
  },
  {
    ...
    "payload": {
      ...
      "patientConcern": "The patient is privately worried that a gluten-free diet will end their social life and that they can never eat out or share family meals again. They will only relax if the dietitian acknowledges this and offers realistic eating-out strategies."
    },
  ...
  },
  {
    ...
    "payload": {
      ...
      "patientConcern": "The patient feels completely well and secretly believes the diet change is pointless and overly restrictive; they fear losing all their favourite foods. They will only engage if the dietitian links phosphate control to preventing future harm and shows the diet can still be enjoyable."
    },
