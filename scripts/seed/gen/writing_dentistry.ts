...
export const ITEMS: Prisma.OetItemCreateManyInput[] = [
  ...
  },
  {
    ...
    "payload": {
      "wordMax": 200,
      "wordMin": 180,
      "caseNotes": "Patient: Ms Carol Whitfield, 45. Presenting complaint: dull ache and sensitivity to heat in upper left back tooth, lingering 30 seconds. Dental history: tooth 26 heavily restored, amalgam placed 12 years ago. Medical history: well controlled asthma; otherwise fit. Medications: salbutamol inhaler as needed. Allergies: none known. Examination: tooth 26 tender to percussion, no swelling, no sinus tract; positive but exaggerated response to thermal testing. Radiograph: periapical radiolucency at mesiobuccal root; pulp chamber and canals appear sclerosed and calcified. Treatment attempted: access cavity started but canals could not be located with hand files; dressed with calcium hydroxide and temporary restoration placed. Plan: refer for endodontic treatment, likely requiring magnification and ultrasonics.",
  ...
  },
  {
    ...
    "payload": {
      "wordMax": 200,
      "wordMin": 180,
      "caseNotes": "Patient: Mr Ryan Doyle, 34. Presenting complaint: toothache and broken tooth; unable to tolerate examination in general practice. Dental history: avoids dental care, last seen 5 years ago; gagging and distress on attempts. Medical history: moderate learning disability, epilepsy (well controlled), lives in supported accommodation; attends with key worker. Medications: sodium valproate. Allergies: none known. Examination (limited): broken-down tooth in lower right quadrant with visible caries; generalised plaque and gingival inflammation; full charting not possible. Plan: refer for assessment with additional support, possible intravenous sedation, and a desensitisation approach; carer consent and best-interests considerations noted; preventive advice given to key worker.",
