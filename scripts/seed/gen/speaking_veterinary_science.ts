...
export const ITEMS: Prisma.OetItemCreateManyInput[] = [
  ...
  },
  {
    ...
    "active": true,
    "payload": {
      "setting": "A veterinary consulting room at a small-animal practice.",
      "patientRole": "The owner is the carer of 'Biscuit', their pet, a 9-year-old overweight cat. They are anxious and have never given an injection before.",
      "prepSeconds": 120,
      "speakSeconds": 300,
      "candidateCard": "Find out the owner's understanding & any worries about managing diabetes at home; explain what diabetes means for the cat and the role of insulin & diet; reassure & demonstrate that injections are manageable; advise on hypoglycaemia warning signs & when to call; agree a recheck/glucose-monitoring plan.",
      "candidateRole": "You are the veterinarian. You have just diagnosed diabetes mellitus in a 9-year-old cat after blood and urine tests. You need to explain the diagnosis, discuss home management including twice-daily insulin injections and dietary change, and agree on a monitoring plan with the owner.",
      "patientConcern": "The owner is secretly terrified they will hurt the cat with the needle and are quietly considering euthanasia because they fear they cannot cope with lifelong injections — draw this out and address it before the consultation ends."
    },
  ...
  },
  {
    ...
    "active": true,
    "payload": {
      "setting": "A veterinary consulting room during a first puppy health check.",
      "patientRole": "The owner is the carer of 'Rocket', their pet, a 9-week-old crossbreed puppy. They have read online that vaccines cause harm and want to delay or skip them.",
      "prepSeconds": 120,
      "speakSeconds": 300,
      "candidateCard": "Find out the source & nature of the owner's concerns about vaccination; explain which diseases the core vaccines prevent & the real (low) risk of side effects; acknowledge their wish to protect the puppy; advise on the recommended schedule & socialisation window; agree on a plan the owner is comfortable with.",
      "candidateRole": "You are the veterinarian. A new owner has brought in a healthy 9-week-old puppy but is reluctant to start the core vaccination course. You need to explore their concerns, explain the benefits and risks of vaccination, address misinformation respectfully, and agree on a way forward.",
      "patientConcern": "The owner's real worry is that a friend's dog became unwell after a vaccine and they feel guilt-tripped by clinics; they want to feel respected and in control rather than pressured — acknowledge this before giving recommendations."
    },
