 ...
 *   Urinary · "Pain on voiding" = `stings`. "burning" is REFUSED.
 ...
 * FAILS THE BUILD on a key that matches no question, or more than one. A
 * silently skipped key would leave a gap with no accept-list and nobody would
 * know.
 */
...
export const LISTENING_PART_A_ACCEPT: Record<string, Record<string, readonly string[]>> = {
  "OET Form 1 · Listening Part A — Physiotherapy consultation (lower back pain)": {
    ...
    "Becomes sharp when he ___": ["bends forward", "bending forward", "bend forward", "bends forwards", "bending forwards"],
    ...
    "Relieving factor (heat source)": ["hot water bottle", "water bottle"],
  ...
  "OET Form 1 · Listening Part A — Dietitian consultation (type 2 diabetes)": {
    ...
    "Lunch sometimes with a ___": ["fizzy drink", "fizzy"],
    "Evening meal often followed by a ___": ["dessert"],
  ...
  "OET Form 2 · Listening Part A — Practice-nurse asthma review": {
    ...
    "The preventer reduces": ["inflammation", "the inflammation"],
    "The preventer works best taken": ["daily"],
    "Not using a": ["spacer"],
    "A spacer helps the medicine reach the": ["lungs"],
    "Night symptoms: cough or": ["wheeze", "wheezing"],
    "Trigger 1": ["cold air", "the cold", "cold"],
    "Trigger 2: her": ["cat"],
  ...
  "OET Form 3 · Listening Part A — Physiotherapist and lower back pain": {
    ...
    "Pain is worse when ___ for a long time": ["sitting", "sits", "sit", "sitting down"],
    ...
    "Better than bed rest: gentle": ["movement", "moving", "gentle movement", "exercise"],
  ...
  "OET Form 3 · Listening Part A — Midwife antenatal booking visit": {
    ...
    "Also feels very": ["tired", "tiredness"],
    "Has gone off": ["coffee"],
    "Taking daily: folic": ["acid", "folic acid"],
    // 🔴 `400 mg` is NEVER here and must never be made equal to any of these.
    "Folic acid dose:": ["400 micrograms", "400 mcg", "400 micrograms a day", "400 ug", "four hundred micrograms"],
    "Folic acid protects the baby's": ["spine", "the spine"],
    "As soon as she found out, she stopped": ["smoking", "smoke"],
  ...
  "Part A — Suspected urinary infection": {
    ...
    "Frequency": ["all the time", "going all the time", "more often"],
    "Urine appearance": ["cloudy", "cloudy urine"],
    "Pain site": ["low in my tummy", "lower tummy", "tummy"],
  },
};
...
export const READING_PART_A_ACCEPT: Record<string, Record<string, readonly string[]>> = {
  ...
  "OET Form 1 · Reading Part A — Preventing pressure injuries": {
    ...
    "non-blanching redness": ["non-blanching redness", "non-blanching", "nonblanching redness", "redness that does not blanch"],
  ...
  "OET Form 2 · Reading Part A — Preventing falls in older adults": {
    ...
    "postural": ["postural", "postural blood pressure", "postural hypotension", "a drop on standing", "lying and standing", "orthostatic"],
