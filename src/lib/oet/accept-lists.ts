...
export const LISTENING_PART_A_ACCEPT: Record<string, Record<string, AcceptRow>> = {
  ...
  "lis-a-script-3-dietetics-unintentional-weight-loss": {
    ...
    g3: { label: "Proportion of the main meal now eaten", accept: ["about half", "half of it"] },
    g5: { label: "Change in taste: everything tastes", accept: ["like a coin", "metallic taste"] },
    g6: { label: "Problem with dentures since losing weight: they have become", accept: ["they are loose"] },
    ...
    g12: { label: "First action agreed: keep a ______ for seven days", accept: ["a food diary", "diary"] },
  },
  "lis-a-script-4-podiatry-an-ulcer-under-the-foot-in-diabetes": {
    ...
    g4: { label: "Pain on pressure", accept: ["no pain", "nothing"] },
  ...
  "lis-a-script-5-dentistry-jaw-pain-and-night-grinding": {
    ...
    g6: { label: "Made worse during the day by", accept: [] },
    ...
    g9: { label: "Coffee intake: ______ a day", accept: ["6", "six coffees"] },
  ...
  "lis-a-script-6-optometry-difficulty-driving-at-night": {
    ...
    g2: { label: "Duration of the problem", accept: ["a year", "one year"] },
    g3: { label: "Change noticed by day: he needs", accept: ["a lamp"] },
    g4: { label: "Appearance of colours", accept: ["grey"] },
    g6: { label: "Last eye test", accept: ["3 years", "3 years ago", "over three years", "three years"] },
    g7: { label: "General health condition", accept: ["blood pressure", "high BP"] },
    ...
    g12: { label: "Plan: refer for", accept: ["surgery"] },
  },
  "lis-a-script-7-pharmacy-a-medicines-review": {
    ...
    g3: { label: "Symptom on standing", accept: ["dizzy", "the room goes"] },
    g4: { label: "Time of day symptom is worst", accept: [] },
    g5: { label: "Falls in the past year", accept: ["2", "two", "two falls"] },
    g6: { label: "Medicine she stopped herself", accept: ["water tablet"] },
    g7: { label: "Reason she stopped it", accept: [] },
    g8: { label: "Repeat prescriptions are ordered by", accept: ["he does", "son"] },
    g9: { label: "Difficulty with the packaging", accept: ["blisters"] },
    g11: { label: "Reason she takes it", accept: ["knees"] },
  ...
  "lis-a-script-9-veterinary-science-a-stiff-older-dog": {
    ...
    g3: { label: "Stiffness is worst", accept: ["first thing in the morning", "in the morning"] },
    g4: { label: "Duration of the problem", accept: ["6 months", "about six months"] },
    g5: { label: "Activity stopped altogether", accept: ["stairs"] },
    ...
    g9: { label: "Owner's main concern", accept: ["pain"] },
    g10: { label: "Examination: reduced movement in both", accept: ["both hips", "hip joints", "the hips"] },
    g11: { label: "Investigation to be arranged", accept: ["x-ray", "xrays"] },
    g12: { label: "Starting today: a two-week trial of", accept: [] },
  },
  "lis-a-script-10-radiography-safety-checks-before-an-mri-scan": {
    ...
    g4: { label: "New symptom this week", accept: ["pins and needles in the leg"] },
    ...
    g9: { label: "Previous eye injury", accept: ["no injury"] },
    g10: { label: "Difficulty reported", accept: ["claustrophobic", "small spaces"] },
  ...
  "lis-a-script-11-speech-pathology-hoarseness-in-a-teacher": {
    ...
    g1: { label: "Occupation", accept: ["teacher"] },
    ...
    g4: { label: "Duration of the problem", accept: ["4 months", "start of the school year"] },
    ...
    g8: { label: "Habit to be addressed first", accept: ["clearing her throat"] },
    g9: { label: "Teaches without a microphone in the", accept: ["the hall", "the sports hall"] },
    g10: { label: "Symptom reported at night", accept: ["acid", "reflux"] },
    g11: { label: "Finding at the ENT clinic", accept: ["nodules both sides"] },
  ...
  "lis-a-script-12-occupational-therapy-recovery-after-a-wrist-fracture": {
    ...
    g1: { label: "Injury", accept: ["fractured wrist", "wrist fracture"] },
    ...
    g6: { label: "Grip strength compared with the other side", accept: ["half", "half of the left"] },
    ...
    g11: { label: "Plan for work: return on", accept: ["half days", "part time"] },
  ...
  "lis-a-script-13-medicine-breathlessness-with-an-irregular-pulse": {
    ...
    g1: { label: "Main symptom", accept: ["breathless"] },
    g2: { label: "Duration", accept: ["2 months"] },
    ...
    g6: { label: "Ankles swell", accept: ["evenings", "in the evening"] },
    ...
    g10: { label: "Examination: the pulse is", accept: ["not steady"] },
    g11: { label: "Arranged today: blood tests and a", accept: ["chest xray", "x-ray"] },
  ...
  "lis-a-script-14-physiotherapy-knee-pain-in-a-runner": {
    ...
    g3: { label: "Site of pain: the ______ of the knee", accept: ["the front"] },
    ...
    g7: { label: "Swelling", accept: ["no swelling", "nothing"] },
    g8: { label: "Giving way", accept: ["it has not", "not given way"] },
    ...
    g11: { label: "Exercise focus", accept: ["hip exercises"] },
  ...
  "lis-a-script-15-nursing-a-pre-operative-assessment": {
    ...
    g5: { label: "Allergy", accept: ["plaster"] },
    g6: { label: "Previous problem with anaesthetic", accept: ["sickness"] },
    ...
    g10: { label: "Clear fluids allowed until ______ in the morning", accept: ["6"] },
...
export const READING_PART_A_ACCEPT: Record<string, Record<string, AcceptRow>> = {
  ...
  "rea-a-f2-preventing-falls-in-older-adults": {
    ...
    q9: { label: "postural", accept: ["postural", "postural blood pressure", "a drop on standing"] },
  ...
  "rea-a-anaphylaxis": {
    // Part A — Anaphylaxis
    q8: { label: "anterolateral thigh", accept: ["the thigh", "thigh"] },
    q9: { label: "5 minutes", accept: ["5 mins", "after 5 minutes", "five minutes"] },
    q10: { label: "mast cell tryptase", accept: ["tryptase"] },
    q11: { label: "80 per cent", accept: ["80%", "about 80%", "eighty per cent"] },
    q13: { label: "two", accept: ["2", "two auto-injectors"] },
    q14: { label: "adolescents", accept: ["adolescence"] },
    q15: { label: "one in five", accept: ["1 in 5", "20 per cent", "20%"] },
    q16: { label: "bradycardia", accept: [] },
  ...
  "rea-a-sepsis": {
    ...
    q9: { label: "2 mmol/L", accept: ["2 mmol/L or above", "two"] },
    ...
    q13: { label: "source control", accept: [] },
    ...
    q19: { label: "blood pressure", accept: ["BP"] },
  ...
  "rea-a-pressure-ulcer-prevention": {
    ...
    q12: { label: "weekly", accept: ["every week"] },
    q13: { label: "unstageable", accept: ["unstageable category"] },
    q14: { label: "twice a day", accept: ["at least twice a day", "two times a day"] },
  ...
  "rea-a-hypoglycaemia": {
    ...
    q10: { label: "between the gum and the cheek", accept: ["gum and cheek", "in the cheek"] },
    ...
    q15: { label: "intoxication", accept: ["a stroke", "drunkenness"] },
    q16: { label: "nothing", accept: ["nothing at all"] },
    q17: { label: "long-acting", accept: ["long acting", "slow-acting"] },
    q18: { label: "medical review", accept: ["a review"] },
    q19: { label: "admission", accept: ["admission and observation", "observation"] },
    q20: { label: "night", accept: ["at night", "the night"] },
  },
  "rea-a-acute-stroke": {
    // Part A — Acute stroke
    q8: { label: "face", accept: ["the face"] },
    q9: { label: "the time of onset", accept: ["last known well", "the time last known well", "time of onset"] },
    q10: { label: "hypoglycaemia", accept: ["hypoglycemia"] },
    q11: { label: "a bleed", accept: ["a bleeding", "bleed"] },
  ...
  "rea-a-preventing-blood-clots-in-hospital": {
    ...
    q10: { label: "being unable to move", accept: ["being immobile", "immobility", "not moving"] },
    q11: { label: "an injected anticoagulant", accept: ["anticoagulant", "anticoagulant injection", "injection", "the injection"] },
    q12: { label: "swelling", accept: ["swollen"] },
    q14: { label: "daily", accept: ["each day", "every day"] },
    q15: { label: "condition", accept: [] },
    q16: { label: "measured", accept: [] },
    q17: { label: "breathing in", accept: ["breathing"] },
    q18: { label: "arterial", accept: ["artery"] },
    q19: { label: "home", accept: ["gone home"] },
    q20: { label: "writing", accept: ["written"] },
  },
  "rea-a-high-risk-medicines": {
    ...
    q11: { label: "label it", accept: ["label the syringe", "labeled", "labelled"] },
  ...
  "rea-a-wound-infection-and-antibiotics": {
    ...
    q9: { label: "when it is clinically infected", accept: ["clinically infected", "only when infected"] },
  ...
  "rea-a-oxygen-therapy": {
    ...
    q16: { label: "varnish", accept: ["nail varnish"] },
    q17: { label: "fifteen", accept: ["15"] },
    q18: { label: "reducing", accept: ["lowering", "turning down"] },
  ...
  "rea-a-acute-kidney-injury": {
    ...
    q19: { label: "chronic kidney disease", accept: [] },
  ...
  "rea-a-chest-pain-and-acute-coronary-syndrome": {
    ...
    q15: { label: "blocked artery", accept: [] },
  ...
  "rea-a-sharps-injury-and-exposure-to-blood": {
    ...
    q17: { label: "hepatitis B", accept: ["hep B"] },
  ...
  "rea-a-a-flare-up-of-chronic-obstructive-lung-disease": {
    ...
    q10: { label: "carbon dioxide", accept: ["CO2"] },
